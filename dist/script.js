...
function () {
  function Download(triggers) {
    ...
    this.path = 'assets/img/mainbg.png';
  }
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      this.slides[this.slideIndex - 1].classList.add('animate__animated', 'animate__fadeIn');
    }
  }, {
    key: "plusSlides",
